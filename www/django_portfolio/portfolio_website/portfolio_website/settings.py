...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DJANGO_DB_USER', 'your-default-db-user'),
        'PASSWORD': os.environ.get('DJANGO_DB_PASSWORD', 'your-default-db'),
...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'defaultpassword')
